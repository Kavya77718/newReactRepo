                        ...
                        <div className="caed col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className="card-body">
                                ...
                                <div className="form-group">
                                        ...
                                        <input placeholder="Id" name="BillingId" className="form-control" value={this.state.billingId} onChange={this.changeBillingIdHandler}/>
                                </div>
                                    <div className="form-group">
                                        <label>Transaction Mode:</label>
                                        <input placeholder="Transaction Mode" name="transactionmode" className="form-control" value={this.state.transactionMode} onChange={this.changeTransactionModeHandler}/>
                                    </div>
                                    <div className="form-group">
                                        <label>Transaction Date</label>
                                        <input placeholder="Transaction Date" name=" transactiondate" className="form-control" value={this.state.transactionDate} onChange={this.changeTransactionDateHandler}/>
                                    </div>
                                    <div className="form-group">
                                        <label>Transaction Status:</label>
                                        <input placeholder=" Transaction Status" name=" transactionstatus" className="form-control" value={this.state.transactionStatus} onChange={this.changeTransactionStatusHandler}/>
                                    </div>
