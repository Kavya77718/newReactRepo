                            ...
                            <div className="card-body">
                                <form onSubmit={this.updateBill}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input id="transactionMode" placeholder="TransactionMode" name="transactionMode" className="form-control" value={this.state.bill.transactionMode} onChange={this.handleChange}/>
                                    </div>
                                    <div className="form-group">
                                        <label>TransactionDate</label>
                                        <input id="transactionDate" placeholder="TransactionDate" name="transactionDate" className="form-control" value={this.state.bill.transactionDate} onChange={this.handleChange}/>
                                    </div>
                                    <div className="form-group">
                                        <label>TransactionStatus:</label>
                                        <input id="transactionStatus" placeholder="TransactionStatus" name="transactionStatus" className="form-control" value={this.state.bill.transactionStatus} onChange={this.handleChange}/>
                                    </div>
